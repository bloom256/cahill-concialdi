...
| `geo-stats-nov` (built) | Photographic Earth with the numbers | November Blue Marble plus white country borders and name, population, GDP and GDP per capita for every country: inside where it fits (6-14 pt on the 190 cm print), otherwise a 6 pt label right on the small country; countries under 1 million people show only their name in regular weight; leader lines only where that spot is taken (a few) | yes | Tiny text needs close viewing or a larger print |
