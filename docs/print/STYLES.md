...
| `geo-blue-marble` (built) | Photographic Earth, winter | NASA Blue Marble NG, December 2004, faint white graticule; no fills, borders or labels | yes (21600x10800 source, rendered at 150 dpi) | Imagery softer near face vertices; large file |
| `geo-blue-marble-june` (built) | Photographic Earth, summer | Same with the June 2004 imagery (green, little snow) | yes | Same |
