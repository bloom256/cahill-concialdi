...
| `geo-stats-nov` (built) | Photographic Earth with the numbers | November Blue Marble plus name, population, GDP and GDP per capita for every country: inside where it fits (5-22 pt), otherwise a 5 pt callout with a leader line | yes | Crowded in Europe and the Caribbean; tiny text needs close viewing or a larger print |
