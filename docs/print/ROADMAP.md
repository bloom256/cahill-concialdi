...
| 9 | 2026-09-15 | Label tuning on `geo-stats-nov`: no outline (worse over snow, reverted), outline thicknesses compared, Barlow Medium/Light, all label text and outlines fully opaque | "Now this is good!" | Frame, title and credits |
| 10 | 2026-09-16 | `geo-stats-nov` at 190 cm with 6-14 pt labels, stats stacked on three lines | "So many names out of country area"; the text also looked large at 100% on screen | Stats on one line ("38.2M / $2.17T / $56.8K") and 5 pt minimum: leader lines drop from 14 to 5 |
| 14 | 2026-09-17 | `geo-stats-nov` with the info panel (title, projection notes, equal-circle distortion map, label key with data years, lines, sources) centered in the southeast Pacific; GDP switched to UN National Accounts 2024 so the map can be sold | "Wow. i am starting to love this map" | Open: Taiwan GDP (DGBAS, open license) or leave it out |
| 13 | 2026-09-16 | `geo-stats-nov` adds full labeled blocks with exact figures (Russia / Pop 144M / GDP $2.59T / GDP/cap $18K) for the 17 countries of at least 3000 mm2 on the print; fonts stay capped at 14 pt | "That looks stunning!" | Open: frame, title, legend and credits |
| 12 | 2026-09-16 | `geo-stats-nov` with ISO3 codes, whole numbers, two-line blocks (DEU/84M over $5T/$60K), rotation only for long thin countries (PCA), one line when tilted (Portugal, Norway, Japan, North Korea), and all label positions optimized jointly | "Cool, i like this a lot!" (117 inside, 0 leader lines, 0 hidden) | Open: one decimal at B and T scale (China and India both read 1B) |
| 11 | 2026-09-16 | True-size previews (143 ppi) at 5, 6 and 7 pt, and with the stats threshold at 1M vs 5M | "This is not readable" at 5 pt. Refused to crop Hawaii or the Line Islands away, and refused to drop numbers from 1-5M countries: "latvia georgia are small but extremly intersting counties" | 7 pt minimum labels; page cropped 45 mm at the top and 85 mm at the bottom (190 x 95.1 cm); stats threshold stays at 1M; Hawaii and the Line Islands named by the new places layer |
